...
export function Model(props: JSX.IntrinsicElements['group']) {
  ...
  const { nodes, materials, animations } = useGLTF('/models/FWorker.glb') as GLTFResult
      ...
      <group name="Root_Scene">
        <group name="RootNode">
          ...
          <group name="Worker_Body" rotation={[-Math.PI / 2, 0, 0]} scale={100}>
            ...
            <skinnedMesh name="Worker_Body_4" geometry={nodes.Worker_Body_4.geometry} material={materials.White} skeleton={nodes.Worker_Body_4.skeleton} />
          </group>
          <group name="Worker_Feet" rotation={[-Math.PI / 2, 0, 0]} scale={100}>
            <skinnedMesh name="Worker_Feet_1" geometry={nodes.Worker_Feet_1.geometry} material={materials.Skin} skeleton={nodes.Worker_Feet_1.skeleton} />
            <skinnedMesh name="Worker_Feet_2" geometry={nodes.Worker_Feet_2.geometry} material={materials.Black} skeleton={nodes.Worker_Feet_2.skeleton} />
          </group>
          <group name="Worker_Head" rotation={[-Math.PI / 2, 0, 0]} scale={100}>
            ...
            <skinnedMesh name="Worker_Head_2" geometry={nodes.Worker_Head_2.geometry} material={materials.Worker_Yellow} skeleton={nodes.Worker_Head_2.skeleton} />
            <skinnedMesh name="Worker_Head_3" geometry={nodes.Worker_Head_3.geometry} material={materials.DarkBrown} skeleton={nodes.Worker_Head_3.skeleton} />
            <skinnedMesh name="Worker_Head_4" geometry={nodes.Worker_Head_4.geometry} material={materials.Brown} skeleton={nodes.Worker_Head_4.skeleton} />
          </group>
